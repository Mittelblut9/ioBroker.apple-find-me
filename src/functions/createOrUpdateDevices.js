                ...
                async function (err, data, res) {
                    ...
                    if (!err && res.statusCode == 200) {
                        ...
                        await adapter.setObjectNotExistsAsync(
                            element.deviceClass + '.' + DiscoveryID,
                            {
                                type: 'device',
                                common: {
                                    name: element.name,
                        ...
                        if (
                            ...
                            if (element.location.altitude == 0.0) {
                                ...
                                urllib.request(
                                    ...
                                    function (err, data, res) {
                                        if (!err && res.statusCode == 200) {
                                            var AltValue = parseFloat(
                                                data.results[0].elevation.toFixed(2)
                                            );
                                            adapter.setState(
                                                element.deviceClass +
                                                    '.' +
                                ...
                                function (err, data, res) {
                                    ...
                                    if (adapter.config.mapprovider === 'osm') {
                                        if (!err && res.statusCode == 200) {
                                            ...
                                            if (data.hasOwnProperty('address')) {
                                                ...
                                                if (AddressObject.hasOwnProperty('road')) {
                                                    ...
                                                    if (
                                                        AddressObject.hasOwnProperty('house_number')
                                                    ) {
                                                        CurrentAddress +=
                                            ...
                                            adapter.log.warn(
                                                'Error on getting address from OpenStreetMaps'
                                            );
                                            adapter.setState(
                                                element.deviceClass +
                                                    '.' +
                                        ...
                                        if (!err && res.statusCode == 200) {
                                            ...
                                            adapter.log.warn(
                                                'Error on getting address from Here-Maps'
                                            );
                                            adapter.setState(
                                                element.deviceClass +
                                                    '.' +
                                        ...
                                        if (!err && res.statusCode == 200) {
                                            ...
                                            adapter.log.warn(
                                                'Error on getting address from Geoapify'
                                            );
                                            adapter.setState(
                                                element.deviceClass +
                                                    '.' +
                                        ...
                                        if (!err && res.statusCode == 200) {
                                            ...
                                            adapter.log.warn(
                                                'Error on getting address from LocationIQ'
                                            );
                                            adapter.setState(
                                                element.deviceClass +
                                                    '.' +
                                        ...
                                        if (!err && res.statusCode == 200) {
                                            try {
                                                ...
                                                adapter.log.warn(
                                                    'Error on getting address from PositionStack: ' +
                                                        e
                                                );
                                                adapter.setState(
                                                    element.deviceClass +
                                        ...
                                        if (!err && res.statusCode == 200) {
                                            ...
                                            adapter.log.warn(
                                                'Error on getting address from TomTom-API'
                                            );
                                            adapter.setState(
                                                element.deviceClass +
                                                    '.' +
                            ...
                            if (activeLocationsWithDistance.length > 0) {
                                const smallestDistanceValue = activeLocationsWithDistance.reduce(
                                    (acc, loc) => (acc.distance < loc.distance ? acc : loc)
                                );
